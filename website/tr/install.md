...
Uygulama, bir APK dosyasından elle kurulur ("sideloading").

1. **Önce sunucuyu kurun.** Windows PC'nize Macro Grid sunucusunu kurup başlatın ([kurulum kılavuzu](https://deccoyi.github.io/macro-grid/guide/install)). Uygulama sunucu olmadan bir işe yaramaz.
2. **APK'yı indirin.** Telefonunuzdan [İndir sayfasına](/tr/download) gidin (ya da bilgisayarda indirip telefona kopyalayın).
3. **Kuruluma izin verin.** APK'yı tarayıcınızın indirilenlerinden veya dosya yöneticinizden açın. Android sorduğunda, o kaynaktan (tarayıcınız veya dosya yöneticisi) uygulama kurulmasına izin verin. Bu ayarın tam ifadesi Android sürümünüze ve telefon üreticinize göre değişir.
