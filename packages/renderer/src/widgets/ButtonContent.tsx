...
/** Shared visual for button, toggle and label widgets: an optional icon positioned around the (possibly multi-line) text. */
export function ButtonContent({ text, icon, iconSize = 28, iconPosition = "top" }: ButtonContentProps) {
  ...
  return (
    <div className="ms-content" style={icon ? { flexDirection: FLEX_DIRECTION[iconPosition], gap: row ? 8 : 4 } : undefined}>
